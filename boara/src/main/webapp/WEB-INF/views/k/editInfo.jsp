	...
	<div class="w3-content w3-center main">
		...
		-->
			...
			<div class="w3-margin-top  w3-content">
				...
				<div class="w3-col m8">
					<input type="password" id="repw" class="w3-margin-bottom w3-margin-left w3-col ft18 input w3-border w3-round-medium" style="height: 54px;">
					<span class="w3-col w3-text-red w3-large w3-center mb5" id="repwmsg"># 비밀번호가 일치하지 않습니다.</span>
				</div>
			</div>
			<div class="w3-margin-top  w3-content">
