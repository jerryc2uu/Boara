...
<c:if test="${not empty param.vw}">
			...
			<div class="mgt20 w3-content">
				...
				<div class="w3-col m8">
					<input type="text" name="id" id="id" class="ft12 w3-margin-bottom w3-margin-left w3-col m9 w3-input w3-border w3-round-medium" 
								placeholder="아이디를 입력하세요 [10글자 이하]">
					<div class=" w3-col m2 w3-right w3-button w3-indigo w3-text-white w3-round-medium ft15" id="idck">check </div>
			...
			<div class="mgt20  w3-content">
				...
				<div class="w3-col m8">
					<input type="text" name="tel" id="tel" class="ft12 w3-margin-bottom w3-margin-left w3-col m9 w3-input w3-border w3-round-medium"
								placeholder="전화번호를 입력하세요 (-제외)">
					<div class=" w3-col m2  w3-right w3-button w3-indigo w3-text-white w3-round-medium ft15 " id="telck">check </div>
			...
			<div class="mgt20 w3-content">
				...
				<div class="w3-col m8">
					<input type="text" name="mail" id="mail" class="ft12 w3-margin-bottom w3-margin-left w3-col m9 w3-input w3-border w3-round-medium"
							placeholder="메일을 입력하세요">
					<div class=" w3-col m2 w3-right w3-button w3-indigo w3-text-white w3-round-medium ft15 " id="mailck">check </div>
