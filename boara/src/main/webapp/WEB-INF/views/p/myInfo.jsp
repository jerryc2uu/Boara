...
<!-- #################여기까진 모든 페이지에서 동일. 복붙해주세요 -->  
	...
	<c:if test="${empty DATA.savename}">
				...
				<div class="w3-rest w3-text-grey" style="margin-top: 50px;">
					...
					<div class="w3-col"> 
					<h4><span class="w3-col m2">포인트 : </span><span class="w3-col m3 w3-margin-right" style="text-align:right;" id="point"><strong>${DATA.sumpoint}</strong></span></h4><div class="w3-rest w3-button w3-indigo w3-hover-blue">충전</div>
					</div>
				</div>  
			</div> 
